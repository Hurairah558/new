...
function AddCourses() {
    ...
    const Dues = Location.state!=undefined?Location.state.AO_Dues:""
    ...
    const set=(e) => {
        ...
        e.preventDefault()
        axios.put("http://localhost:3001/api/ao/dues",formdata)
        .then((res)=>{
            if (res.data.message){
                                ...
                                <MDBCardBody>
                                    <div className="row d-flex justify-content-center">
                                        <div className="col-md-3">
                                            <textarea class="form-control" onChange={change} value={formdata.AO_Dues} id="exampleFormControlTextarea1" name="AO_Dues" placeholder="Dues" rows="3"></textarea>
                                        </div>
