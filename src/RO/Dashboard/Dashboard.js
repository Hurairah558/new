      ...
      <MDBCard cascade narrow>
          <MDBRow>
            <MDBCol md='12'>
              ...
              >
                <h4 className='h4-responsive mb-0 font-weight-bold'>Registrar Office Dashboard</h4>
              </MDBView>
              <MDBCardBody>
        <div className="row">
          ...
          <MDBRow>
            <MDBCol md='12'>
              ...
              <div className="col-md-4">
                <Link to="/ro/students" className="nav-link" href="#">
            ...
            <div className="col-md-4">
                    ...
                    <Link to="/ro/students2" className="nav-link text-white" href="#">
                    <MDBCard className="panel" style={{paddingTop:20,paddingBottom:35}}>
                        <MDBRow className='mt-3'>
                            <MDBCol md='5' col='5' className='text-left pl-4'>
                                <MDBBtn
            ...
            <div className="col-md-4">
                    ...
                    <Link to="/ro/admission_controller" className="nav-link text-white" href="#">
                    <MDBCard className="panel" style={{paddingTop:20,paddingBottom:35}}>
                        <MDBRow className='mt-3'>
                            <MDBCol md='5' col='5' className='text-left pl-4'>
                                <MDBBtn
                            ...
                            <MDBCol md='7' col='7'>
                                <h5 style={{marginTop:30,color:'black'}} className='font-weight-bold'>Admission Controller</h5>
                            </MDBCol>
                        </MDBRow>
                    </MDBCard>
                        </Link>
