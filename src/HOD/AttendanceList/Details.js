                ...
                <div class="container">
                    <MDBCard style={{opacity:op}} cascade narrow>
                        <MDBRow>
                            ...
                            >
                                <h4 className='h4-responsive mb-0 font-weight-bold'>Attendance List</h4>
                            </MDBView>
                                <MDBCardBody>
                                    ...
                                    <table className="table table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  className="text-primary" style={{fontSize:15,fontWeight:'bolder',textAlign:'center'}}>Attendancee (%)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
