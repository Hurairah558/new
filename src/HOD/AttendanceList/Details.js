...
function Details() {
    ...
    useEffect(()=>{
        //http://localhost:3001/api/ssio/attendancedetails

        axios.post("http://localhost:3001/api/ssio/attendancedetails",JSON.stringify(login).includes("HOD")?location.state.Course:"").then((res)=>{
                ...
                <div class="container">
                    <MDBCard style={{opacity:op}} cascade narrow>
                        <MDBRow>
                            ...
                            >
                                <h4 className='h4-responsive mb-0 font-weight-bold'>{data[0].Department}&nbsp;&nbsp;&nbsp;{data[0].Course_Title}&nbsp;&nbsp;&nbsp;{data[0].Course_Code}&nbsp;&nbsp;&nbsp;Attendance List&nbsp;&nbsp;&nbsp;{data[0].Instructor}&nbsp;&nbsp;&nbsp;{data[0].Fall_Spring}</h4>
                            </MDBView>
                                <MDBCardBody>
                                    <table className="table table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  className="text-primary" style={{fontSize:15,fontWeight:'bolder',textAlign:'center'}}>Attendance</th>
                                            ...
                                            {data.map((Student,index)=>{
                                                return(
                                                    <tr key={index}>
                                                        ...
                                                        <td style={{fontWeight:'bold',textAlign:'center'}}>{Student.Attendance}</td>
