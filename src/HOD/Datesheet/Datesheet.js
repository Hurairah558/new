...
function Datesheet() {
    ...
    useEffect(()=>{
        axios.post("http://localhost:3001/api/hod/datesheet",{Department:login!=null?login.Department:""}).then((res)=>{
    ...
    const changeselect = (e) => {
        ...
        const changeselects = (e) => {
            setop(0.3)
            setloading(true)
            axios.post("http://localhost:3001/api/hod/datesheet",{Department:login!=null?login.Department:"",Fall_Spring:e.value}).then((res)=>{
                    setdata(res.data.data)
                    setloading(false)
                    setop(1)
                }).catch((err)=>{
